...
export declare function searchPageText(document: mupdf.PDFDocument, pageNumber: number, searchString: string, maxHits?: number): [number, number, number, number, number, number, number, number][][];
